...
import org.apache.pekko.persistence.typed.scaladsl.{ Effect, EventSourcedBehavior, ReplicatedEventSourcing }
import sample.persistence.res.MainApp

/**
 * The MovieWatchList shows how to use a built in CRDT as the state.
 *
 * An [[org.apache.pekko.persistence.typed.crdt.ORSet]] is used to represent a list of movies a user has watched.
 */
